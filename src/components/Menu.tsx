...
const Menu: React.FC<MenuProps> = ({ menuItems, addToCart, onBuyNow, selectedCategory = 'all', loading = false }) => {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {(categoriesLoading || loading) ? (
          ...
          filteredCategories.map((category) => {
            ...
            return (
              <section key={category.id} id={category.id} className="mb-12 scroll-mt-40">
