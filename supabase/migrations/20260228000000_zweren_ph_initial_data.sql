-- Profound + Kitchen Initial Data Migration
...
INSERT INTO menu_items (id, name, description, base_price, category, popular, available, image_url) VALUES
  ('sig-ov-tee', 'Signature Oversized Tee', 'Premium 240GSM cotton, drop-shoulder fit. Minimalist Profound chest embroidery.', 750, 'premium-tees', true, true, 'https://images.pexels.com/photos/1656684/pexels-photo-1656684.jpeg?auto=compress&cs=tinysrgb&w=800'),
...
-- Limited
INSERT INTO menu_items (id, name, description, base_price, category, popular, available, image_url) VALUES
  ('hoodie-v1', 'Profound Hoodie v1', 'Limited release. Ultra-soft fleece lining, high-density print logo.', 1200, 'limited', true, true, 'https://images.pexels.com/photos/6347888/pexels-photo-6347888.jpeg?auto=compress&cs=tinysrgb&w=800');
...
-- Update Site Settings to Profound + Kitchen
INSERT INTO site_settings (id, value, type, description) VALUES
  ('site_name', 'Profound + Kitchen', 'text', 'The name of the restaurant'),
  ('site_logo', '/images/brand-logo.png', 'image', 'The logo image for the site'),
  ('site_description', 'Elevate your daily style with Profound + Kitchen premium apparel', 'text', 'Short description of the store')
